...
class Scoreboard:
    ...
    def __init__(self, settings, screen, stats):
        ...
        self.font = pygame.font.SysFont(None, 40) # instantiate the font object
    ...
    def show_score(self):
        ...
        self.screen.blit(self.score_image, self.score_rect) # Draw the score image to the screen at the location specified byt score_rect
